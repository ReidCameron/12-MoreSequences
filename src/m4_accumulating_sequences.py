...
def rectangles_from_circles(circles):
    ...
    for k in range(len(circles)):
        p1 = rg.Point(circles[k].center.x,circles[k].center.y)
        p2 = rg.Point(circles[k].center.x,circles[k].center.y)
        p1.move_by(-circles[k].radius,-circles[k].radius)
        p2.move_by(circles[k].radius, circles[k].radius)
